- Add reference to Terrasoft.Messaging.Common.Standard, you can find it in 
**[AppPath]\bin\Terrasoft.Messaging.Common.Standard.dll**


- Create new MsgChannelUtilities class
```C#
using System;
...
namespace DevelopmentTraining.Files.cs
{
