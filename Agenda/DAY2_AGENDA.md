...
- [WebSocket](../Wiki/Web-Socket-Messages-with-MsgChannelUtilities.md) WebSocket with MsgChannelUtilities
...
- [CreatioSDK](../Wiki/Creatio-NuGet-Repository.md) - Necessary libraries
